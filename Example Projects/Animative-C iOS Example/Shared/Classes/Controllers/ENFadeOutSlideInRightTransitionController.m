...
@interface ENFadeOutSlideInRightTransitionController ()
...
@implementation ENFadeOutSlideInRightTransitionController
{
	ENFadeOutSlideInRightAnimator *_fadeOutSlideInRightAnimator;
}
    ...
    bundle: (NSBundle *)bundle
{
	...
	// Initialize view.
	[self _initializeFadeOutSlideInRightTransitionController];
...
{
	_fadeOutSlideInRightAnimator.presenting = YES;
	return _fadeOutSlideInRightAnimator;
}
- (id <UIViewControllerAnimatedTransitioning>)animationControllerForDismissedController:(UIViewController *)dismissed
{
	_fadeOutSlideInRightAnimator.presenting = NO;
	return _fadeOutSlideInRightAnimator;
}
